...
TEST(ArraySequence_int, GetSubsequence) {
    ...
    unique_ptr<ArraySequence<int>>
            arr2 = unique_ptr<ArraySequence<int>>(arr1.Subsequence(0, 0));
    ...
    arr2 = unique_ptr<ArraySequence<int>>(arr1.Subsequence(0, 4));
    ...
    arr2 = unique_ptr<ArraySequence<int>>(arr1.Subsequence(2, 3));
...
TEST(ArraySequence_float, GetSubsequence) {
    ...
    unique_ptr<ArraySequence<float>>
            arr2 = unique_ptr<ArraySequence<float>>(arr1.Subsequence(0, 0));
    ASSERT_EQ(arr2->GetLength(), 1);
    EXPECT_EQ (arr1[0], 1);
    EXPECT_ANY_THROW(arr2->Get(1));
    EXPECT_ANY_THROW(arr1.Subsequence(-1, 0));
    EXPECT_ANY_THROW(arr1.Subsequence(1, 0));
    EXPECT_ANY_THROW(arr1.Subsequence(1, 5));
    arr2 = unique_ptr<ArraySequence<float>>(arr1.Subsequence(0, 4));
    ASSERT_EQ(arr2->GetLength(), 5);
    EXPECT_EQ (arr1[0], arr2->Get(0));
    EXPECT_EQ (arr1[1], arr2->Get(1));
    EXPECT_EQ (arr1[2], arr2->Get(2));
    EXPECT_EQ (arr1[3], arr2->Get(3));
    EXPECT_EQ (arr1[4], arr2->Get(4));
    arr2 = unique_ptr<ArraySequence<float>>(arr1.Subsequence(2, 3));
    ASSERT_EQ(arr2->GetLength(), 2);
    EXPECT_EQ (arr1[2], arr2->Get(0));
    EXPECT_EQ (arr1[3], arr2->Get(1));
}
